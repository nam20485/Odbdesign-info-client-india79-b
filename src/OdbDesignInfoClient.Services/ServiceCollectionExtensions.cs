...
public static class ServiceCollectionExtensions
{
    ...
    /// <param name="restBaseUrl">The base URL for the REST API.
    ...
    /// <param name="timeoutSeconds">The HTTP timeout for REST requests in seconds.</param>
    /// <returns>The service collection for chaining.</returns>
    public static IServiceCollection AddOdbDesignInfoClientServices(
        this IServiceCollection services,
        string restBaseUrl = "https://debian13vm.tail11ba79.ts.net:443",
        int timeoutSeconds = 30)
    {
        ...
        services.AddRefitClient<IOdbDesignRestApi>()
            .ConfigureHttpClient(c =>
            {
                ...
                c.Timeout = TimeSpan.FromSeconds(Math.Max(timeoutSeconds, 5));
            })
